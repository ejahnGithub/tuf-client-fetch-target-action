...
const withTempFile = async (handler) => withTempDir(async (dir) => {
    const file = await promises_1.default.open(path_1.default.join(dir, 'tempfile'), 'w+');
    try {
...
const withTempDir = async (handler) => {
    ...
    try {
        ...
        promises_1.default.rm(dir, { recursive: true });
    }
};
